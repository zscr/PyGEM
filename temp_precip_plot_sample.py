...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 14:35:50 2019
...
ds = xr.open_dataset(os.getcwd() + '/../Output/simulations/CanESM2/R1_CanESM2_rcp45_c1_ba1_1sets_1950_2017.nc')
...
fig, ax = plt.subplots(2, 1, squeeze=False, sharex=False, sharey=False, gridspec_kw = {'wspace':0.4, 'hspace':0.15})
...
ax[0,0].plot(x_values, y_values, color='k', linewidth=1, zorder=2, label='Temperature')
ax[0,0].set_ylabel('Temperature [degC]', size=12)

#ax[0,0].scatter(x_values, y_values, color='k', zorder=2, s=2)

#ax[0,0].scatter(x_values, y_values[7,:], color='m', zorder=2, s=2)
ax[1,0].plot(x_values, y2_values, color='b', linewidth=1, zorder=2, label='Precipitation')
ax[1,0].set_ylabel('Precipitation [m]', size=12)
...
ax[0,0].text(0.5, 0.99, 'Test glaciers', size=10, horizontalalignment='center', verticalalignment='top', 
...
figure_fn = 'temp_precip_plot_sample9.png'
